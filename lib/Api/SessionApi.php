...
class SessionApi
{
     ...
     */
    public function createSessionRequest($sessionPayload)
    {
        ...
        if (isset($sessionPayload)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($sessionPayload));
            } else {
                $httpBody = $sessionPayload;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAllSessionsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteExpiredSessionsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSessionRequest($uuid)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSessionSsoTokenRequest($uuid, $tokenId)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function enableSession($uuid, $body = null)
    {
        $this->enableSessionWithHttpInfo($uuid, $body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function enableSessionWithHttpInfo($uuid, $body = null)
    {
        $request = $this->enableSessionRequest($uuid, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function enableSessionAsync($uuid, $body = null)
    {
        return $this->enableSessionAsyncWithHttpInfo($uuid, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function enableSessionAsyncWithHttpInfo($uuid, $body = null)
    {
        $returnType = '';
        $request = $this->enableSessionRequest($uuid, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function enableSessionRequest($uuid, $body = null)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function enableSessionForEquisoftConnectRequest($uuid, $enableEquisoftConnectPayloadSchema = null)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($enableEquisoftConnectPayloadSchema)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($enableEquisoftConnectPayloadSchema));
            } else {
                $httpBody = $enableEquisoftConnectPayloadSchema;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSessionRequest($uuid, $keepAlive = null)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($keepAlive !== null) {
            if('form' === 'form' && is_array($keepAlive)) {
                foreach($keepAlive as $key => $value) {
                    $queryParams[$key] = ObjectSerializer::toString($value);
                }
            }
            else {
                $queryParams['keepAlive'] = ObjectSerializer::toString($keepAlive);
            }
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSessionSsoTokenRequest($uuid, $tokenId)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function impersonateRequest($uuid, $impersonatePayload)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($impersonatePayload)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($impersonatePayload));
            } else {
                $httpBody = $impersonatePayload;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \Equisoft\SDK\AccountService\Model\Session|\Equisoft\SDK\AccountService\Model\ErrorPayload
     */
    public function revertIdentity($uuid, $body = null)
    {
        list($response) = $this->revertIdentityWithHttpInfo($uuid, $body);
        return $response;
    }
     ...
     * @return array of \Equisoft\SDK\AccountService\Model\Session|\Equisoft\SDK\AccountService\Model\ErrorPayload, HTTP status code, HTTP response headers (array of strings)
     */
    public function revertIdentityWithHttpInfo($uuid, $body = null)
    {
        $request = $this->revertIdentityRequest($uuid, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revertIdentityAsync($uuid, $body = null)
    {
        return $this->revertIdentityAsyncWithHttpInfo($uuid, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revertIdentityAsyncWithHttpInfo($uuid, $body = null)
    {
        $returnType = '\Equisoft\SDK\AccountService\Model\Session';
        $request = $this->revertIdentityRequest($uuid, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function revertIdentityRequest($uuid, $body = null)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setSessionSsoTokenRequest($uuid, $tokenId, $body)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
