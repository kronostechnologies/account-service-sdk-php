...
class SessionApi
{
    ...
    /**
     * Operation enableSessionForCrm
     *
     * Enable session for the crm service
     *
     * @param  string $uuid uuid (required)
     * @param  bool $bumpOldestSession When concurrent access exceeded, delete oldest session (optional)
     *
     * @throws \Equisoft\SDK\AccountService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function enableSessionForCrm($uuid, $bumpOldestSession = null)
    {
        $this->enableSessionForCrmWithHttpInfo($uuid, $bumpOldestSession);
    }

    /**
     * Operation enableSessionForCrmWithHttpInfo
     *
     * Enable session for the crm service
     *
     * @param  string $uuid (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function enableSessionForCrmWithHttpInfo($uuid, $bumpOldestSession = null)
    {
        $request = $this->enableSessionForCrmRequest($uuid, $bumpOldestSession);
    ...
    /**
     * Operation enableSessionForCrmAsync
     *
     * Enable session for the crm service
     *
     * @param  string $uuid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function enableSessionForCrmAsync($uuid, $bumpOldestSession = null)
    {
        return $this->enableSessionForCrmAsyncWithHttpInfo($uuid, $bumpOldestSession)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation enableSessionForCrmAsyncWithHttpInfo
     *
     * Enable session for the crm service
     *
     * @param  string $uuid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function enableSessionForCrmAsyncWithHttpInfo($uuid, $bumpOldestSession = null)
    {
        $returnType = '';
        $request = $this->enableSessionForCrmRequest($uuid, $bumpOldestSession);
    ...
    /**
     * Create request for operation 'enableSessionForCrm'
     *
     * @param  string $uuid (required)
     * @param  bool $bumpOldestSession When concurrent access exceeded, delete oldest session (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function enableSessionForCrmRequest($uuid, $bumpOldestSession = null)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uuid when calling enableSessionForCrm'
            );
        }
        if (strlen($uuid) < 1) {
            throw new \InvalidArgumentException('invalid length for "$uuid" when calling SessionApi.enableSessionForCrm, must be bigger than or equal to 1.');
        }


        $resourcePath = '/sessions/{uuid}/enable/crm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($bumpOldestSession !== null) {
            $queryParams['bumpOldestSession'] = ObjectSerializer::toQueryValue($bumpOldestSession);
        }
     ...
     * @throws \Equisoft\SDK\AccountService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Equisoft\SDK\AccountService\Model\Session|\Equisoft\SDK\AccountService\Model\ErrorPayload|\Equisoft\SDK\AccountService\Model\ErrorPayload
     */
     ...
     * @throws \Equisoft\SDK\AccountService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Equisoft\SDK\AccountService\Model\Session|\Equisoft\SDK\AccountService\Model\ErrorPayload|\Equisoft\SDK\AccountService\Model\ErrorPayload, HTTP status code, HTTP response headers (array of strings)
     */
