...
class OrganizationRoleApi
{
     ...
     */
    protected function createOrUpdateRoleRequest($organisationId, $roleId, $createRole)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRoleRequest($organizationId, $createRole)
    {
