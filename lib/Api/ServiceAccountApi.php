...
class ServiceAccountApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchServiceAccountRequest($name = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateServiceAccountRequest($uuid, $serviceAccountUpdateSchema)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($serviceAccountUpdateSchema)) {
            $_tempBody = $serviceAccountUpdateSchema;
        }
